...
Elm.RandomGif.make = function (_elm) {
   ...
   var headStyle = $Html$Attributes.style(_U.list([A2(_op["=>"],"width","200px"),A2(_op["=>"],"text-align","center")]));
   ...
   var RequestNone = {ctor: "RequestNone"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"width","200px")]))]),
      _U.list([A2($Html.h2,_U.list([headStyle]),_U.list([$Html.text(model.topic)]))
              ,A2($Html.div,_U.list([imgStyle(model.gifUrl)]),_U.list([]))
              ,A2($Html.button,_U.list([A2($Html$Events.onClick,address,RequestNone)]),_U.list([$Html.text("More Please!")]))]));
   });
   var Model = F2(function (a,b) {    return {topic: a,gifUrl: b};});
   var init = function (topic) {    return {ctor: "_Tuple2",_0: A2(Model,topic,"public/media/waiting.gif"),_1: getRanDomGif(topic)};};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "RequestNone") {
...
Elm.RandomGifPair.make = function (_elm) {
   ...
   var init = F2(function (left,right) {
      var _p0 = $RandomGif.init(right);
      var r = _p0._0;
      var rfx = _p0._1;
      var _p1 = $RandomGif.init(left);
      var l = _p1._0;
      var lfx = _p1._1;
      return {ctor: "_Tuple2",_0: A2(Model,l,r),_1: $Effects.batch(_U.list([A2($Effects.map,Left,lfx),A2($Effects.map,Right,rfx)]))};
   });
   var update = F2(function (action,model) {
      var _p2 = action;
      if (_p2.ctor === "Left") {
            ...
            var l = _p3._0;
            var fx = _p3._1;
            return {ctor: "_Tuple2",_0: A2(Model,l,model.right),_1: A2($Effects.map,Left,fx)};
         } else {
            var _p4 = A2($RandomGif.update,_p2._0,model.right);
            var r = _p4._0;
            var fx = _p4._1;
            return {ctor: "_Tuple2",_0: A2(Model,model.left,r),_1: A2($Effects.map,Right,fx)};
         }
   });
