...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var userPhoto = function (user) {
      var _p0 = user;
      if (_p0.ctor === "Anonymous") {
            return "a";
         } else {
            return A2($Basics._op["++"],"users/",A2($Basics._op["++"],_p0._0,"photo.png"));
         }
   };
   var LoggedIn = function (a) {    return {ctor: "LoggedIn",_0: a};};
   var Anonymous = {ctor: "Anonymous"};
   var activeUsers = _U.list([Anonymous,LoggedIn("quan"),Anonymous]);
   var toString = function (v) {    var _p1 = v;switch (_p1.ctor) {case "All": return "hello";case "Active": return "Active";default: return "completed";}};
   var Completed = {ctor: "Completed"};
   var Active = {ctor: "Active"};
   var All = {ctor: "All"};
   var names = _U.list(["python","java","haskell"]);
   var fail = 32;
